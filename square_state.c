...
const int VISITED_SQUARE = '.';		// ASCII code for visited
const int UNVISITED_SQUARE = ' ';	// ASCII code for unvisited
const int GOAL_SQUARE = '*';			// ASCII code for goal
const int WALL_SQUARE = '=';		// ASCII code for wall
